package com.example.learncodeonlinedemo.utils;

/**
 * Created by avinashchitturi on 29-08-2016.
 */
...
import com.example.learncodeonlinedemo.R;
...
public class CircularAnim {
    ...
    public static class FullActivityBuilder {
        ...
        private int mColorOrImageRes = R.color.colorPrimary;
        private Long mDurationMills;
        private OnAnimationEndListener mOnAnimationEndListener;
        private int mEnterAnim = R.anim.fade_in, mExitAnim = R.anim.fade_out;
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            try {
                ...
                anim.setDuration((long) (finalDuration * 0.4));
                anim.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
